							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive role-table">
												...
												<tr>
													...
													@foreach($permissions[0] as $permission)
														<td class="text-center">
															<a href="#" data-id="{{ $permission }}" data-statue="{!! in_array($permission, $userPermissions) ? '1' : '0' !!}" onclick="addPermission(event, this)" class="access-icon role">
																<span class="@if (in_array($permission, $userPermissions)) 
																feather feather-check text-success icon-style-circle bg-success-transparent @else 
																feather feather-x text-danger icon-style-circle bg-danger-transparent @endif"></span>
															</a>
														</td>
													@endforeach
												</tr>
										...
										<input type="hidden" value="{{ implode(',', $userPermissions) }}," name="permission_ids" id="permission_ids">
