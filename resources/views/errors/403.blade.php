				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-7 mt-6">
							...
							<h1 class="mb-3 font-weight-semibold">با عذرخواهی، دسترسی شما به این بخش ممکن نیست!</h1>
							<p class="font-weight-normal mb-7 leading-normal" style="font-size:1.5rem;">لطفاً با مدیر سیستم تماس بگیرید..</p>
